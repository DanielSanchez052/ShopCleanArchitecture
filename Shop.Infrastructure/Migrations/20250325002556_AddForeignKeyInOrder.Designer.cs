...
namespace Shop.Infrastructure.Migrations
{
    ...
    [Migration("20250325002556_AddForeignKeyInOrder")]
    partial class AddForeignKeyInOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Entities.Delivery.DeliveryProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DeliveryProvider", "delivery");
                });
            ...
            modelBuilder.Entity("Shop.Entities.Payment.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shop.Entities.Catalog.ProductType", b =>
                {
                    b.OwnsOne("Shop.Entities.Catalog.ProductTypeConfig", "Config", b1 =>
                        {
                            b1.Property<int>("ProductTypeId")
                                .HasColumnType("int");

                            b1.Property<bool?>("SendMail")
                                .HasColumnType("bit");

                            b1.Property<bool>("UseDigitalInventory")
                                .HasColumnType("bit");

                            b1.Property<bool>("UseReferenceInventory")
                                .HasColumnType("bit");

                            b1.HasKey("ProductTypeId");

                            b1.ToTable("ProductType", "catalog");
            ...
            modelBuilder.Entity("Shop.Entities.Catalog.ProgramProduct", b =>
                {
                    ...
                    b.HasOne("Shop.Entities.Delivery.DeliveryProvider", "DeliveryProvider")
                        .WithMany("ProgramProducts")
            ...
            modelBuilder.Entity("Shop.Entities.Delivery.DeliveryProvider", b =>
                {
                    b.OwnsOne("Shop.Entities.Delivery.DeliveryProviderConfig", "Config", b1 =>
                        {
                            b1.Property<int>("DeliveryProviderId")
                                .HasColumnType("int");

                            b1.Property<string>("StartDeliveryProvider")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("UpdateDetailProvider")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("UpdateOrderProvider")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");

                            b1.HasKey("DeliveryProviderId");

                            b1.ToTable("DeliveryProvider", "delivery");
            ...
            modelBuilder.Entity("Shop.Entities.Ordering.Order", b =>
                {
                    ...
                    b.HasOne("Shop.Entities.Payment.PaymentType", "PaymentType")
                        .WithMany("Orders")
