...
public class Result
{
    ...
    protected Result(bool isSuccess, Error error, Error[]? errors = null)
    {
    ...
    public static Result<TValue> Create<TValue>(TValue value, Error error, Error[]? errors = null)
        where TValue : class
        => value is null ? Failure<TValue>(error, errors) : Success(value);
    ...
    public static Result Failure(Error error, Error[]? errors = null) => new(false, error, errors);
    ...
    /// </remarks>
    public static Result<TValue> Failure<TValue>(Error error, Error[]? errors = null) => new(default!, false, error, errors);
